                    ...
                    <table class="table app-table-hover mb-0 text-left">
                        <thead>
                            <tr>
                                ...
                                <th class="cell" style="width:10%">LACO Name</th>
                                <th class="cell" style="width:30%">E-Mail</th>
                                    ...
                                    {{-- @if($key->status==1) --}}
                                        ...
                                        <td class="cell" style="text-align: center;">
                                            ...
                                            <div class="col-auto mx-1">
                                                ...
                                                <a class="text-primary" href="{{ route('mail.edit', $key->id) }}" title="แก้ไข">
                                        ...
                                        <td class="cell" style="text-align: center;">
                                            {{-- @if(empty($mig[$key->id])) --}}
                                                <div class="col-auto mx-1">
                                                    ...
                                                    <a class="text-danger" href="{{ route('mail_del', $key->id) }}" title="ลบ">
